...
drop table sc_stock_movement_trx_fct;
...
location_type	varchar(32)	,
location_timezone_id	varchar(50)	,
product_key	varchar(50)	,
product_ref_timestamp	timestamp	,
product_code	varchar(32)	,
...
create index idx_sc_location_history_dim on sc_location_history_dim (location_key,location_type)

create index idx_sc_supplier_catalog_history_dim on sc_supplier_catalog_history_dim (catalog_code,supplier_code,supplier_key,supplier_catalog_key)


create index idx_cfs_team_member_hist_dim on cfs_team_member_hist_dim (location_type,location_number)

create index idx_sc_supplier_history_dim on sc_supplier_history_dim (supplier_key,supplier_code,supplier_type)

create index idx_sc_product_history_dim on sc_product_history_dim (product_key,product_code,category_code)
